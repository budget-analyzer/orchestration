...
See [@service-common/CLAUDE.md](https://github.com/budgetanalyzer/service-common/blob/main/CLAUDE.md) for architecture layers, naming conventions, and testing patterns.
```
...
## Spring Boot Patterns
See [@service-common/CLAUDE.md](https://github.com/budgetanalyzer/service-common/blob/main/CLAUDE.md) for standard conventions.
